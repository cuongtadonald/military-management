...
import { App, Button, Col, Form, Input, InputNumber, Modal, Row, Select, DatePicker, Divider, Tabs, Card, Space, Tag, Popconfirm, Switch, Upload, Avatar } from "antd"
import { PlusOutlined, DeleteOutlined, EditOutlined, UserOutlined, TeamOutlined, UploadOutlined } from "@ant-design/icons"
                ...
                <div style={{ textAlign: "center", marginBottom: 16 }}>
                  ...
                  >
                    <Button size="small" icon={<UploadOutlined />} block>
                      {photoPreview || soldier?.PhotoPath ? "Đổi ảnh" : "Tải ảnh"}
                    </Button>
                  </Upload>
                </div>
              </Col>
              ...
              <Col span={6}>
                <Form.Item name="SoldierType" label="Loại quân nhân" rules={[{ required: true, message: "Chọn loại quân nhân" }]}>
                  <Select placeholder="Chọn loại quân nhân">
                    ...
                    <Option value="HSQ-CS">Hạ sĩ quan - Chiến sĩ</Option>
                  </Select>
                </Form.Item>
              </Col>
            </Row>
